...
int main() {
    ...
    cout << endl;
     ...
     cout << "14) Halle la descomposicion LU de r: " << endl;
     cout << "r: " << endl;
     cout << r << endl;
     tuple<Cvector<double>, Cmatrix<double>, Cmatrix<double>> LUr = r.LUP(0.00001);
     cout << "r = PLU: " << endl;
     cout << "P: " << get<0>(LUr) << endl;
     cout << "L: " << endl;
     cout << get<1>(LUr) << endl;
     cout << "U: " << endl;
     cout << get<2>(LUr) << endl;
    ...
    cout << endl;
     ...
     cout << "15) Halle los valores propios de r: " << endl;
     cout << "r: " << endl;
     cout << r << endl;
     Cvector<double> vpr = r.eigen_values(0.000001);
     cout << "Eigen Values of m5: " << vpr << endl;
